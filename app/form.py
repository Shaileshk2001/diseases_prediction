...
class mri_patient_form(forms.Form):
    first_name = forms.CharField(widget=forms.TextInput(attrs={'class': "form-control", 'type' : 'text', 'placeholder' : 'Patient First Name'}), required=True)
    last_name = forms.CharField(widget=forms.TextInput(attrs={'class': "form-control", 'type' : 'text', 'placeholder' : 'Patient Last Name'}), required=True)
    contact = forms.DecimalField(widget=forms.NumberInput(attrs={'class': "form-control", 'type' : 'number', 'placeholder' : 'Patient Contact Number'}), required=True)
    age = forms.DecimalField(widget=forms.NumberInput(attrs={'class': "form-control", 'type' : 'number', 'placeholder' : 'Age'}), required=True)
    mri_image = forms.FileField(widget=forms.FileInput(attrs={'class': "form-control", 'type' : 'file', 'placeholder' : 'Select Image', 'accept' : 'image/png, image/jpg, image/jpeg'}), required=True)
