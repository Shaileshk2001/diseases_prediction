...
from app.process import multidisease_detection, list_generate, mri_disease_detection
from django.contrib.auth.decorators import login_required
from django.views.decorators.cache import cache_control
from .form import patient_form, mri_patient_form
from app.models import Patient_data, mri_patient_data, doctors_data
